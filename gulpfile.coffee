...
# task to run a build status server and a connect server
...
gulp.task 'deploy-staging', ['prod-js', 'prod-css'], -> deploy envs.staging
gulp.task 'deploy-production', ['prod-js', 'prod-css'], -> deploy envs.production
